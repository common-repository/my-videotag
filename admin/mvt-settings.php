...
<script type="text/javascript" src="<?php echo MVT_URLPATH;?>js/my-videotag-scripts.js"></script>
<div class="icon32" id="icon-videotag"><br></div>
<h2>My-Videotag <?php echo __('Settings', 'my-videotag')?></h2>
<div id="poststuff">
<div class="postbox">
<h3 class="hndle" id="mvttitle"><span><?php echo __('Are you satisfied with my work?', 'my-videotag')?></span></h3>
...
<h3 class="hndle" id="mvttitle"><span style="font-size:17px;font-weight:bold;"><?php _e('Dimensions of the videos', 'my-videotag') ?></span><span style="float:right"><small><?php echo ''.get_version_mvt().''; ?></small></span></h3>
<div class="inside" style="display: block;">
 <div style="width: 100%">
 
<div id="mvtconfig" style="width: 69%; float: left;">
<p><?php _e('Enter the default video size.', 'my-videotag') ?> <a class="mvttooltip" href="#"><abbr id="mvtincognito">?</abbr><span class="mvtcustom mvthelp"><img src="<?php echo MVT_URLPATH;?>images/Help.png" alt="<?php _e('You can also use:', 'my-videotag') ?> [video w='640' h='390'] URL VIDEO [/video]" height="48" width="48" /><?php _e('You can also use:', 'my-videotag') ?> <br />[video w='640' h='390'] URL VIDEO [/video]</span></a></p> 
...
<tr valign="top">
<th scope="row" id="mvtfontstyle" style="width: 120px;"><label for="mvt_options[width]" style="font-weight: bold;"><?php _e('Width', 'my-videotag') ?></label></th> 
...
<tr valign="top">
<th scope="row" id="mvtfontstyle" style="width: 120px;"><label for="mvt_options[height]" style="font-weight: bold;"><?php _e('Height', 'my-videotag') ?></label></th> 
...
<tr valign="top">
<th scope="row" id="mvtfontstyle" style="width: 120px;"><label for="mvt_options[width]" style="font-weight: bold;"><?php _e('Style (CSS)', 'my-videotag') ?></label></th> 
<td>
...
<tr valign="top">
<th scope="row" id="mvtfontstyle" style="width: 15px;"><input name="mvt_options[comments]" type="checkbox" value="1" <?php if (isset($mvt['comments']) == "1") echo 'checked="checked"'; ?> /></th>
<td id="mvtfontstyle"><label for="mvt_options[comments]" style="font-weight: bold;"><?php _e('Enable/Disable display videos in comments', 'my-videotag') ?> <a class="mvttooltip" href="#"><abbr id="mvtincognito">?</abbr><span class="mvtcustom mvthelp"><img src="<?php echo MVT_URLPATH;?>images/Help.png" alt="<?php _e('If you have problems with plugins Disqus Comment System or Intense Debate do not enable this option.', 'my-videotag') ?>" height="48" width="48" /><?php _e('If you have problems with plugins Disqus Comment System or Intense Debate do not enable this option.', 'my-videotag') ?></span></a></label>
</td>
</tr>         
</table>
...
<table class="form-table">
<tr valign="top">
<th scope="row" id="mvtfontstyle" style="width: 15px;"><input name="mvt_options[authormoney]" type="checkbox" value="1" <?php if (isset($mvt['authormoney']) == "1") echo 'checked="checked"'; ?> /></th>
<td id="mvtfontstyle"><label for="mvt_options[authormoney]" style="font-weight: bold;"><?php _e('Contribute to the author', 'my-videotag') ?> <a class="mvttooltip" href="#"><abbr id="mvtincognito">?</abbr><span class="mvtcustom mvthelp"><img src="<?php echo MVT_URLPATH;?>images/Help.png" alt="<?php _e('Allow external links open with adf.ly to generate revenue and continue to improve the plugin.  Thank you!.', 'my-videotag') ?>" height="48" width="48" /><?php _e('Allow external links open with adf.ly to generate revenue and continue to improve the plugin.  Thank you!.', 'my-videotag') ?></span></a></label>
</td>
</tr>         
</table>

<p class="submit">
<input type="submit" id="mvtsave" style="font-size: 14px !important;padding:10px;" value="<?php _e('Save Changes', 'my-videotag') ?>" />
</p>  
