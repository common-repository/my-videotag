...
//vidbull.com
array ('/vidbull\.com\/(.*).html/i', '<div class="myvideotag" style="width: '.$w.'px;" id="myvideotag"><iframe frameborder="0" scrolling="no" width="'.$w.'" height="'.$h.'" src="http://vidbull.com/embed-{ID_VIDEO}-640x318.html" allowFullScreen></iframe></div>'),

//tudou.com
array ('/tudou\.com\/programs\/view\/([^\/]*)/i', '<div class="myvideotag" style="width: '.$w.'px;" id="myvideotag"><embed src="http://www.tudou.com/v/{ID_VIDEO}/&resourceId=0_05_02_99&tid=0/v.swf" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" wmode="opaque" width="'.$w.'" height="'.$h.'"></embed></div>'),

//clipmass.com
array ('/clipmass\.com\/movie\/([^\/]*)/i', '<div class="myvideotag" style="width: '.$w.'px;" id="myvideotag"><iframe width="'.$w.'" height="'.$h.'" src="http://www.clipmass.com/embed/{ID_VIDEO}" frameborder="0" allowfullscreen></iframe></div>'),

//redtube.com
array ('/redtube\.com\/([^\/]*)/i', '<div class="myvideotag" style="width: '.$w.'px;" id="myvideotag"><object width="'.$w.'" height="'.$h.'"><param name="allowfullscreen" value="true"><param name="AllowScriptAccess" value="always"><param name="movie" value="http://embed.redtube.com/player/"><param name="FlashVars" value="id={ID_VIDEO}&style=redtube&autostart=false"><embed src="http://embed.redtube.com/player/?id={ID_VIDEO}&style=redtube" allowfullscreen="true" AllowScriptAccess="always" flashvars="autostart=false" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="'.$w.'" height="'.$h.'" /></object></div>'),
